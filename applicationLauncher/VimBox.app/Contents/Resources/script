...
if [ -e "${DIR}/VimBox.app" ]; then
  ...
  if [ -e "/Applications/MacVim.app" ]; then
    ...
    cat "${DIR}/VimBoxCheckout/application/VimBoxInitWrapper.sh" > "${DIR}/VimBox.app/Contents/MacOS/Vim" || FAILMSG="Failed creating Vim wrapper script. Does ${DIR}/VimBoxInitWrapper.sh exist?"

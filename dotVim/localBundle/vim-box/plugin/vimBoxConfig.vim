...
function! VimBoxPathsplane()
  ...
  \ ":           └─ settings.json    # Settings defaults",
  \ ":        ├─ vim-taste/",
  \ ":        ...",
  \ ":        └─ color-tools/",
  \ "",
  \ "g:vimBoxInstallationRoot = " . VimBoxNiceDir(g:vimBoxInstallationRoot),
  \ "> Installation root of VimBox.",
  \ "",
  \ "g:vimBoxStockPluginsDir = " . VimBoxNiceDir(g:vimBoxStockPluginsDir),
  \ "> Initial vimrc file belonging to VimBox, not for users. ",
  \ "> Runs the auto-generated vimrc " . VimBoxNiceDir(g:vimBoxGeneratedRc),
  \ "> Then sources " . VimBoxNiceDir(g:vimBoxUserInit),
  \ "> The vim-box stock plugin includes the default settings.json",
  \ "> You can view this via :SettingsDefault",
  \ "",
  \ "",
  \ " Cache Data                                                                    ",
  \ "",

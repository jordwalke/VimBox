...
if has('gui_running') || &t_Co == 88 || &t_Co == 256 || &t_Co == 16777216
  ...
  call <sid>X('markdownBlockquote',          s:fg_dim,    '' ,        'italic')
  ...
  " call <sid>X('markdownItalicDelimiter',     s:syntax_bg,  s:syntax_bg, 'italic')
  " call <sid>X('markdownBoldDelimiter',       s:syntax_bg,  s:syntax_bg, 'italic')
